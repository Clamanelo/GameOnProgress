function light_update() {
	...
	draw_clear(c_black);
	draw_sprite_ext(sprite_index, image_index, lw / 2, lh / 2, image_xscale, image_yscale, image_angle, image_blend, image_alpha);   
	with (Par_Collision) {
	  if(object_index!=obj_CardBox)&&(object_index!=obj_3DBox) {
